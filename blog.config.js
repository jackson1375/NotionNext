...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '明天', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '外貿，科技，模擬飛行博主，歡迎關注。', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://jason111.buzz', // 网站地址
